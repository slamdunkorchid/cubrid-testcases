...
C1: create table t1 (a int default 0,b int default 10,c int default 20);
C1: insert into t1(b) values (1),(2),(3),(4),(5);
C1: COMMIT;
...
C3: update t1 set b = 6 where b= 5;
MC: wait until C3 blocked;

C4: delete from t1 where b=4;
