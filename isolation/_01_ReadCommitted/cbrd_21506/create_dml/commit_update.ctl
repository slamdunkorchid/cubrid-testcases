...
C3: update t set i=(select sum(k) from t) where k=10;
...
/* verification */
C1: select sum(set{i}) into :s from t ignore index (a) where k > -999 order by 1;
C1: select sum(set{i}) into :i from t force index (a) where k > -999 order by 1;
