...
C1: create table t1 (a int,b int default 10,c double default 20);
C1: insert into t1(a) values (1),(2),(3),(4),(5);
C1: COMMIT;
...
C3: insert into t1(b) values (1);
MC: wait until C3 blocked;

C4: delete from t1 where b = 1;
...
/* verification */
C1: select sum(set{b}) into :s from t1 ignore index (i) where c > -999 order by 1;
C1: select sum(set{b}) into :i from t1 force index (i) where c > -999 order by 1;
