...
/* verification */
C1: select sum(set{k}) into :s from t ignore index (a) where k>-3 order by 1;
C1: select sum(set{k}) into :i from t force index (a) where k >-3 order by 1;
