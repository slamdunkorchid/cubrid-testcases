...
C1: CREATE INDEX idx_t1_id ON t1(id) with online parallel 2;
C1: CREATE TABLE t2(id INT, col VARCHAR(10));
C1: CREATE INDEX idx_t2_id ON t2(id) with online parallel 2;
C1: CREATE TABLE t3(valueid INT, str VARCHAR(10));
C1: CREATE INDEX idx_t3_id ON t3(valueid) with online parallel 2;
