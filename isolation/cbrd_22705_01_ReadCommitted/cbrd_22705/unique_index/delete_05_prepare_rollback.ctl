...
prepare statement to delete duplicate data and rollback while loading index with online parallel 2;
...
C2: create unique index i on t1(b,c) with online parallel 2 with online parallel 2;
