...
C1: CREATE INDEX idx_id on t1(id) WHERE id >= 4 with online parallel 2;
C1: CREATE INDEX idx_read on t1(read_count) WHERE read_count BETWEEN 1 and 3 with online parallel 2;
C1: COMMIT WORK;
